...
public class PlacePreviewEntity extends ItemFrameEntity implements IEntityAdditionalSpawnData
{
    ...
    public PlacePreviewEntity(final EntityType<? extends PlacePreviewEntity> p_i50224_1_, final World p_i50224_2_) {
        super((EntityType)p_i50224_1_, p_i50224_2_);
        this.currentType = null;
        this.currentTypeStack = ItemStack.EMPTY;
        this.tile = Blocks.SAND.defaultBlockState();
    }
    ...
    public static PlacePreviewEntity createInstanceFromPos(final World worldIn, final BlockPos placePos, final Direction dir, final Item type) {
        final PlacePreviewEntity e = new PlacePreviewEntity(SlashBlade.RegistryEvents.PlacePreview, worldIn);
        e.pos = placePos;
        e.setDirection(dir);
        e.currentType = type;
        return e;
    ...
    public static PlacePreviewEntity createInstance(final FMLPlayMessages.SpawnEntity spawnEntity, final World world) {
